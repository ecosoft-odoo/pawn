...
class account_balance_pawn(report_sxw.rml_parse, common_report_header):
    _name = 'report.account.account_balance_pawn'

    def __init__(self, cr, uid, name, context=None):
        super(account_balance_pawn, self).__init__(cr, uid, name, context=context)
        self.sum_debit = 0.00
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(account_balance_pawn, self).set_context(objects, data, new_ids, report_type=report_type)
    ...
    def _get_account(self, data):
        ...
        return super(account_balance_pawn, self)._get_account(data)
...
report_sxw.report_sxw('report.account.account_balance_pawn', 'account.account', 'addons/pawn_account_report_extension/report/account_balance.rml', parser=account_balance_pawn, header="internal")
