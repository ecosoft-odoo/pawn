...
#         return res
    ...
    _columns = {
        ...
        'date_extend_last': fields.date('Last Extend Date', required=False, readonly=True, track_visibility='onchange', help="Latest Date on which this document has been extended."),
        'date_unextend_last': fields.date('Last Unextend Date', required=False, readonly=True, track_visibility='onchange', help="Latest Date on which this document has been unextended."),
